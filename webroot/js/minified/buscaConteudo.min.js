...
document.querySelectorAll(".pwd").forEach(function(currentValue,currentIndex,listObj){currentValue.addEventListener("change",estaComprometida)});async function buscaUserPass(event){let button=event.target;if(button.tagName=='I'){button=button.parentElement}
