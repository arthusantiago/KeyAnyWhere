...
*/
    ...
    switch ($param['severidade']) {
        case 0: // EMERGENCY
            ...
            break;
        case 1: // ALERT
            $stringHTML = "<span class='badge rounded-pill' style='background-color:#ff6c00;'>{$param['exibicao']}</span>";
            break;
        case 2: // CRITICAL
            $stringHTML = "<span class='badge rounded-pill bg-warning'>{$param['exibicao']}</span>";
            break;
        case 3: // ERROR
            $stringHTML = "<span class='badge rounded-pill' style='background-color:#b03878;'>{$param['exibicao']}</span>";
            break;
        case 4: // WARNING
